...
//		Serial.println(playStepType);
	...
	if (stepNoteP[patternNum][seqState.seqPos[patternNum]].trig == TRIGTYPE_PLAY) {
		...
		pendingNoteOffs.insert(stepNoteP[patternNum][seqState.seqPos[patternNum]].note, seqState.getPatternChannel(patternNum), noteoff_micros, sendnoteCV);
		...
		// Queue note-on
		pendingNoteOns.insert(stepNoteP[patternNum][seqState.seqPos[patternNum]].note, seqState.seq_velocity, seqState.getPatternChannel(patternNum), noteon_micros, sendnoteCV);
